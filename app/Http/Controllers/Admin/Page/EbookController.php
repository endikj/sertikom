...
class EbookController extends Controller
{
    ...
    {
            $data = Ebook::select('ebooks.id', 'ebooks.judul', 'ebooks.id_kategori', 'ebooks.pengarang', 'ebooks.tahun', 'ebooks.rekomendasi', 'ebooks.publish', 'kategoris.kategori')
    ...
    public function edit(Request $request)
    {
        ...
        echo json_encode(['status' => TRUE, 'isi' => $ebook]);
    }
